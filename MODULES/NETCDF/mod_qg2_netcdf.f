...
c    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
c    !! This subroutine reads data from the netcdf file at the start time !!
...
c    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
c    !! Write data in netcdf file during the run. 
c    !! Note that zeta is 'Relative Vorticity'
...
c    !! This subroutine just checks for errors while writing data in netcdf.   
     ...
     +       len(Psi_UNITS), Psi_UNITS)
      ...
      subroutine read_ave(file_name,ii,jj,psi1_av,psi2_av,time_day)
